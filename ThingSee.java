...
public class ThingSee {
    ...
    private Double         temperature, humidity, batLevel, lumi;
    ...
    public Double useTemperature()
            {
                return temperature;
            }

    public Double useHumidity()
            {
                return humidity;
            }
    public Double useBatLevel()
            {
                return batLevel;
            }
    public Double useLumi()
            {
                return lumi;
            }
    //This is for testing
   /*public List getsensorValue(JSONArray events) throws Exception {
        ...
        try {
            for (int i = 0; i < events.length(); i++) {
                ...
                for (int j = 0; j < senses.length(); j++) {
                    ...
                    switch (senseID) {
                        case GROUP_ENVIRONMENT | PROPERTY1:
                            sensorValue.setTemp((float) value);
                            k++;
                            break;
                    }
            ...
            throw new Exception("No temperature");
        }
        temperature.get(0);
        return temperature;
    }*/
